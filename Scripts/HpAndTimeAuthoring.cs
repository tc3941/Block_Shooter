...
public class HpAndTimeAuthoring : MonoBehaviour, IConvertGameObjectToEntity
{
    ...
    public float hpCurrent, hpMax, hps, mpCurrent, mpMax, mps, mpMin;
    ...
    public void Convert(Entity entity, EntityManager dstManager, GameObjectConversionSystem conversionSystem)
    {
        ...
        HpAndTimeRunTime data = new HpAndTimeRunTime { hpCurrent = hpCurrent, hpMax = hpMax, hps = hps, mpCurrent = mpCurrent, mpMax = mpMax, mps = mps, mpMin= mpMin, timeStopped = timeStopped };
