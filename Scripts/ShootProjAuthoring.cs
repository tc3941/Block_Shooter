...
public class ShootProjAuthoring : MonoBehaviour, IConvertGameObjectToEntity
{
    ...
    // For example,
    //    public float scale;
    public float speedDivisor,damage;
    ...
    public void Convert(Entity entity, EntityManager dstManager, GameObjectConversionSystem conversionSystem)
    {
        ...
        dstManager.AddComponentData(entity, new ShootProjRunTime { speedDivisor = speedDivisor, damage = damage});
