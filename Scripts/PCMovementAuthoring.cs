...
public class PCMovementAuthoring : MonoBehaviour, IConvertGameObjectToEntity
{
    ...
    public float playerX, playerZ, speedDivisor;
    ...
    public void Convert(Entity entity, EntityManager dstManager, GameObjectConversionSystem conversionSystem)
    {
        ...
        PCMovementRunTime data = new PCMovementRunTime { playerX = playerX, playerZ = playerZ, speedDivisor = speedDivisor };
